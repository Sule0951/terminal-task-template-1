...
7. Keep all task files, calibration results, attestations, and both commits in your private repository, then either add `@xicovarisco` as a read collaborator or send the archive produced by `./scripts/export-task.sh tasks/<task>`.
